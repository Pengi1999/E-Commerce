...
class RvAdapterCategory (private var ds:List<String>, private val eventCategoryItemListening:EventCategoryItemListening): RecyclerView.Adapter<RvAdapterCategory.CategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            holder.itemView.setOnClickListener {
                eventCategoryItemListening.onClickItemListening(position)
            }
        }
    }
}